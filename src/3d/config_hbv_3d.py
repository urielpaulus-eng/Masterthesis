...
Zentrale Parameterdatei für dein 3D HBV Modell.
...
GEOMETRY = {
    ...
    # Kervengeometrie
    "kerf_depth": 30.0,         # Kerventiefe d_n [mm]
    "kerf_length": 300.0,       # Kervenlänge l_n [mm]
    "lv": 400.0,                # Vorholzlänge l_v [mm]
...
# Materialparameter für Kerven-Bereich
